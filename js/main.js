...
document
  ...
  .addEventListener("click", () => scrollToSection("projectSection"));
document
  .getElementById("ExperienceBtn")
  .addEventListener("click", () => scrollToSection("experienceSection"));
document
  .getElementById("educationBtn")
  .addEventListener("click", () => scrollToSection("educationSection"));
