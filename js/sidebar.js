    ...
    <div class="sidebardiv">
        <ul>
            <li>
                ...
                <svg id="sidebarClose" class="sidebar-close button-nature" xmlns="http://www.w3.org/2000/svg" height="24px"
            ...
            <li>
                <a title="Home" class="sidebar-btn active button-nature" href="/">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
                        <path
            ...
            <li>
                <a title="Blog" class="sidebar-btn button-nature" href="https://blog.sayanmondal.in">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
                        <path
            ...
            <li>
                <a title="Shop" class="sidebar-btn button-nature" href="https://shop.sayanmondal.in">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
                        <path
            ...
            <li>
                <a href="https://www.linkedin.com/in/analystsayan/" target="_blank" title="LinkedIn" class="sidebar-btn button-nature">
            ...
            <li>
                <a href="https://github.com/analystsayan" target="_blank" title="Github" class="sidebar-btn button-nature">
            ...
            <li>
                <a href="/settings" title="Settings" class="sidebar-btn button-nature">
